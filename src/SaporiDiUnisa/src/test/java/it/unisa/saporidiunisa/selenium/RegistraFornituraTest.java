...
public class RegistraFornituraTest extends Configuration {
    ...
    class Incorrect {
        ...
        @DisplayName("1.1.15")
        void tc_1_1_15() {
            fillForm("Pangrattato", "Mulino Bianco", "60.00", "100", "2024-02-09", new File("src/main/webapp/img/favicon/site.webmanifest"));
    ...
    void fillForm(String nome, String marchio, String prezzo, String quantita, String dataScadenza, File file) {
        ...
        jsExecutor.executeScript("document.getElementById('quantita').type = 'text';");
        quantitaInput.clear();
        quantitaInput.sendKeys(quantita);
        val prezzoInput = driver.findElement(By.id("prezzo"));
        jsExecutor.executeScript("document.getElementById('prezzo').type = 'text';");
        prezzoInput.clear();
        ...
        jsExecutor.executeScript("document.getElementById('dataScadenza').type = 'text';");
        dataScadenzaInput.clear();
        dataScadenzaInput.sendKeys(dataScadenza);
