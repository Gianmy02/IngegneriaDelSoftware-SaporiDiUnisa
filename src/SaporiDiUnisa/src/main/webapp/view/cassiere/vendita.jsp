...
<head>
    ...
    <script src="${pageContext.request.contextPath}/script/cassiere/calculateTotal.js" defer></script>
    <script src="${pageContext.request.contextPath}/script/cassiere/confirmSale.js" defer></script>
